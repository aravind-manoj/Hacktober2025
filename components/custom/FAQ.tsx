...
import background from "@/public/assets/faq-bg.png"; // <-- This is your image
...
const HacktoberFaqPage: React.FC = () => {
    ...
    return (
      <main>
        {/* --- APPLY BACKGROUND IMAGE VIA STYLE ATTRIBUTE --- */}
        <div
            className="min-h-screen p-8 bg-cover bg-center bg-no-repeat"
            style={{ 
                // Use the imported image's source for the background
                backgroundImage: `url(${background.src})`,
                // Keep the original color as a fallback in case the image doesn't load
                backgroundColor: '#28022E', 
            }}
        >
