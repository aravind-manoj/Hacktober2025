...
export default function CustomButton({ variant, className }: { variant: "dark" | "light", className?: string }) {
    return (
        <div className="flex-shrink-0">
            <Button className={`${ variant === "dark" ? "bg-gray-900 hover:bg-gray-800 text-orange-500" : "bg-orange-500 hover:bg-orange-400 text-gray-900"} ${className} font-bold rounded-full flex items-center space-x-3 transition-all duration-200 shadow-lg cursor-pointer`}>
